...
export default async function handler(req, res) {
  ...
  try {
    const response = await client.messages.create({
      ...
      // A dense chapter can exceed this and get cut off mid-JSON, which then
      // fails to parse and surfaces as a 502. Sonnet allows far more, and you
      // are only billed for what's generated, so a high ceiling costs nothing
      // on short chapters and prevents truncation on long ones.
      max_tokens: 32000,
